...
namespace P6Travels_API_SebastianSanchoA.Models;
...
public partial class P620242travelsContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__Country__10D160BFE3A23953");
        ...
        {
            entity.HasKey(e => e.DestionationId).HasName("PK__Destinat__12F2541FDF95B728");
        ...
        {
            entity.HasKey(e => e.HostingId).HasName("PK__Hosting__B2C2DF8496249028");
        ...
        {
            entity.HasKey(e => e.ReservationId).HasName("PK__Reservat__B7EE5F047718EC69");
        ...
        {
            entity.HasKey(e => e.ActivityId).HasName("PK__Schedule__45F4A7F141A6FF2D");
        ...
        {
            entity.HasKey(e => e.TourId).HasName("PK__Tour__604CEA109CA8F19C");
        ...
        {
            entity.HasKey(e => e.TransportId).HasName("PK__Transpor__19E9A17D92827A1F");
        ...
        {
            entity.HasKey(e => e.TravelId).HasName("PK__Travel__E931521511F26A2C");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCAC7DF42FDA");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A5539244186");
